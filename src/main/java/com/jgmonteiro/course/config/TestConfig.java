...
import com.jgmonteiro.course.entities.Payment;
...
import com.jgmonteiro.course.repositories.OrderItemRepository;
...
public class TestConfig implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		OrderItem oi1 = new OrderItem(o1, p1, 2, p2.getPrice());
